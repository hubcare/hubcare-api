...
style:
	...
	sudo docker-compose exec commit-metrics pycodestyle .
	sudo docker-compose exec community-metrics pycodestyle .
	sudo docker-compose exec issue-metrics pycodestyle .
	sudo docker-compose exec pull-request-metrics pycodestyle .
